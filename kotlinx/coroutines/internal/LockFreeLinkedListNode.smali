...
.method private final correctPrev()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    :cond_2d
    instance-of v5, v1, Lkotlinx/coroutines/internal/Removed;
...
.method private final finishAdd(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;)V
    ...
    invoke-virtual {v2, p1, v0, p0}, Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;->compareAndSet(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public final addLast(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;I)Z
    ...
    instance-of v0, v1, Lkotlinx/coroutines/internal/ListClosed;

    if-eqz v0, :cond_1b

    move-object v0, v1

    check-cast v0, Lkotlinx/coroutines/internal/ListClosed;

    iget v0, v0, Lkotlinx/coroutines/internal/ListClosed;->forbiddenElementsBitmask:I

    and-int/2addr v0, p2

    if-nez v0, :cond_19

    invoke-virtual {v1, p1, p2}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->addLast(Lkotlinx/coroutines/internal/LockFreeLinkedListNode;I)Z
...
.method public final removeOrNext()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
    ...
    invoke-direct {v0}, Lkotlinx/coroutines/internal/LockFreeLinkedListNode;->correctPrev()Lkotlinx/coroutines/internal/LockFreeLinkedListNode;
