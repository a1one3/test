...
.method public final invoke(Lkotlinx/datetime/format/DateTimeFormatBuilder$WithDateTimeComponents;)V
    ...
    sget-object v1, Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$1;->INSTANCE:Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$1;

    aput-object v1, v2, v6

    sget-object v1, Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$2;->INSTANCE:Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$2;
    ...
    invoke-interface {p1, v0}, Lkotlinx/datetime/format/DateTimeFormatBuilder$WithDateTimeComponents;->dayOfMonth(Lkotlinx/datetime/format/Padding;)V

    move-object v0, p1

    check-cast v0, Lkotlinx/datetime/format/DateTimeFormatBuilder;

    invoke-static {v0, v5}, Lkotlinx/datetime/format/DateTimeFormatBuilderKt;->char(Lkotlinx/datetime/format/DateTimeFormatBuilder;C)V

    sget-object v0, Lkotlinx/datetime/format/MonthNames;->Companion:Lkotlinx/datetime/format/MonthNames$Companion;

    invoke-virtual {v0}, Lkotlinx/datetime/format/MonthNames$Companion;->getENGLISH_ABBREVIATED()Lkotlinx/datetime/format/MonthNames;

    move-result-object v0

    invoke-interface {p1, v0}, Lkotlinx/datetime/format/DateTimeFormatBuilder$WithDateTimeComponents;->monthName(Lkotlinx/datetime/format/MonthNames;)V
    ...
    invoke-static {v0, v3, v4, v3}, Lkotlinx/datetime/format/DateTimeFormatBuilder$WithDate$DefaultImpls;->year$default(Lkotlinx/datetime/format/DateTimeFormatBuilder$WithDate;Lkotlinx/datetime/format/Padding;ILjava/lang/Object;)V
    ...
    sget-object v0, Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$4;->INSTANCE:Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$4;

    aput-object v0, v1, v6

    sget-object v0, Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$5;->INSTANCE:Lkotlinx/datetime/format/DateTimeComponents$Formats$RFC_1123$1$5;
