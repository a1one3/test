...
.field private isBadChunkData:Z
...
.field private isNonStandardPadding:Z

.field private metadataChunkList:Ljava/util/List;
...
.method public constructor <init>(Lorg/jaudiotagger/audio/wav/WavOptions;)V
    ...
    iput-object v0, p0, Lorg/jaudiotagger/tag/wav/WavTag;->metadataChunkList:Ljava/util/List;

    iput-boolean v1, p0, Lorg/jaudiotagger/tag/wav/WavTag;->isBadChunkData:Z

    iput-boolean v1, p0, Lorg/jaudiotagger/tag/wav/WavTag;->isNonStandardPadding:Z
...
.method public addMetadataChunkSummary(Lorg/jaudiotagger/audio/iff/ChunkSummary;)V
    .registers 3

    iget-object v0, p0, Lorg/jaudiotagger/tag/wav/WavTag;->metadataChunkList:Ljava/util/List;
...
.method public getMetadataChunkSummaryList()Ljava/util/List;
    .registers 2
...
.method public isBadChunkData()Z
    .registers 2

    iget-boolean v0, p0, Lorg/jaudiotagger/tag/wav/WavTag;->isBadChunkData:Z
...
.method public isNonStandardPadding()Z
    .registers 2

    iget-boolean v0, p0, Lorg/jaudiotagger/tag/wav/WavTag;->isNonStandardPadding:Z

    return v0
.end method

.method public setBadChunkData(Z)V
    .registers 2

    iput-boolean p1, p0, Lorg/jaudiotagger/tag/wav/WavTag;->isBadChunkData:Z
...
.method public setNonStandardPadding(Z)V
    .registers 2

    iput-boolean p1, p0, Lorg/jaudiotagger/tag/wav/WavTag;->isNonStandardPadding:Z
...
.method public syncToId3FromInfoIfEmpty()V
    ...
    invoke-virtual {v2, v0}, Lorg/jaudiotagger/audio/generic/AbstractTag;->getFirst(Lorg/jaudiotagger/tag/FieldKey;)Ljava/lang/String;
    ...
    :try_end_3b
    .catch Lorg/jaudiotagger/tag/FieldDataInvalidException; {:try_start_0 .. :try_end_3b} :catch_3c
...
.method public syncToId3FromInfoOverwrite()V
    ...
    invoke-virtual {v5, v0}, Lorg/jaudiotagger/audio/generic/AbstractTag;->getFirst(Lorg/jaudiotagger/tag/FieldKey;)Ljava/lang/String;
    ...
    :try_end_35
    .catch Lorg/jaudiotagger/tag/FieldDataInvalidException; {:try_start_0 .. :try_end_35} :catch_36
    ...
    :try_end_46
    .catch Lorg/jaudiotagger/tag/FieldDataInvalidException; {:try_start_41 .. :try_end_46} :catch_36
...
.method public syncToInfoFromId3IfEmpty()V
    ...
    invoke-virtual {v2, v0, v3}, Lorg/jaudiotagger/audio/generic/AbstractTag;->setField(Lorg/jaudiotagger/tag/FieldKey;[Ljava/lang/String;)V
    :try_end_41
    .catch Lorg/jaudiotagger/tag/FieldDataInvalidException; {:try_start_0 .. :try_end_41} :catch_42
...
.method public syncToInfoFromId3Overwrite()V
    ...
    invoke-virtual {v2, v0}, Lorg/jaudiotagger/audio/generic/AbstractTag;->deleteField(Lorg/jaudiotagger/tag/FieldKey;)V
    :try_end_46
    .catch Lorg/jaudiotagger/tag/FieldDataInvalidException; {:try_start_41 .. :try_end_46} :catch_36
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lorg/jaudiotagger/audio/generic/AbstractTag;->toString()Ljava/lang/String;
