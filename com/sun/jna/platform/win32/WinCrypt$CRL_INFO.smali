...
.method public getRgCRLEntry()[Lcom/sun/jna/platform/win32/WinCrypt$CRL_ENTRY;
    ...
    new-array v0, v2, [Lcom/sun/jna/platform/win32/WinCrypt$CRL_ENTRY;

    :goto_7
    return-object v0

    :cond_8
    const-class v0, Lcom/sun/jna/platform/win32/WinCrypt$CRL_ENTRY;

    iget-object v1, p0, Lcom/sun/jna/platform/win32/WinCrypt$CRL_INFO;->rgCRLEntry:Lcom/sun/jna/Pointer;

    invoke-static {v0, v1}, Lcom/sun/jna/Structure;->newInstance(Ljava/lang/Class;Lcom/sun/jna/Pointer;)Lcom/sun/jna/Structure;

    move-result-object v0

    check-cast v0, Lcom/sun/jna/platform/win32/WinCrypt$CRL_ENTRY;

    iget v1, p0, Lcom/sun/jna/platform/win32/WinCrypt$CRL_INFO;->cCRLEntry:I
...
.method public getRgExtension()[Lcom/sun/jna/platform/win32/WinCrypt$CERT_EXTENSION;
    ...
    iget-object v1, p0, Lcom/sun/jna/platform/win32/WinCrypt$CRL_INFO;->rgExtension:Lcom/sun/jna/Pointer;
    ...
    iget v1, p0, Lcom/sun/jna/platform/win32/WinCrypt$CRL_INFO;->cExtension:I
