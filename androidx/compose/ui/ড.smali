.class public final Landroidx/compose/ui/ড;
...
.method public static final Ϳ(Landroidx/compose/ui/Ϡ;)Ljava/util/Map;
    ...
    const-string/jumbo v3, "Меню навігацыі"
    ...
    const-string/jumbo v3, "Выпадное меню"
    ...
    const-string/jumbo v3, "Закрыць меню навігацыі"
    ...
    const-string/jumbo v3, "Закрыць аркуш"
    ...
    const-string/jumbo v3, "Памылка ўводу"
    ...
    const-string/jumbo v3, "Пачатак пераліку"
    ...
    const-string/jumbo v3, "Канец пераліку"
    ...
    const-string/jumbo v3, "Абвестка"
