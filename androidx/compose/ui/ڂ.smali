.class public final Landroidx/compose/ui/ڂ;
...
.method public static final Ϳ(Landroidx/compose/ui/Ϡ;)Ljava/util/Map;
    ...
    const-string/jumbo v3, "Меню за навигация"
    ...
    const-string/jumbo v3, "Падащо меню"
    ...
    const-string/jumbo v3, "Затваряне на менюто за навигация"
    ...
    const-string/jumbo v3, "Затваряне на таблицата"
    ...
    const-string/jumbo v3, "Въведеното е невалидно"
    ...
    const-string/jumbo v3, "Начало на обхвата"
    ...
    const-string/jumbo v3, "Край на обхвата"
