.class public final Landroidx/compose/ui/ѣ;
...
.method public static final Ϳ(Landroidx/compose/ui/Ϡ;)Ljava/util/Map;
    ...
    const-string/jumbo v3, "Мени за навигација"
    ...
    const-string/jumbo v3, "Паѓачко мени"
    ...
    const-string/jumbo v3, "Затворете го менито за навигација"
    ...
    const-string/jumbo v3, "Затворете го листот"
    ...
    const-string/jumbo v3, "Неважечки запис"
    ...
    const-string/jumbo v3, "Почеток на опсегот"
    ...
    const-string/jumbo v3, "Крај на опсегот"
    ...
    const-string/jumbo v3, "Предупредување"
