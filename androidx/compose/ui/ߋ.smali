.class public final Landroidx/compose/ui/ߋ;
...
.method public static final Ϳ(Landroidx/compose/ui/Ϡ;)Ljava/util/Map;
    ...
    const-string/jumbo v3, "Меню навігації"
    ...
    const-string/jumbo v3, "Спадне меню"
    ...
    const-string/jumbo v3, "Закрити меню навігації"
    ...
    const-string/jumbo v3, "Закрити аркуш"
    ...
    const-string/jumbo v3, "Введено недійсні дані"
    ...
    const-string/jumbo v3, "Початок діапазону"
    ...
    const-string/jumbo v3, "Кінець діапазону"
    ...
    const-string/jumbo v3, "Сповіщення"
